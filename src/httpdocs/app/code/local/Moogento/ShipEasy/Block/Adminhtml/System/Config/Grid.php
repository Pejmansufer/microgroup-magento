    ...
    protected function _getAdditionalFields($columnId)
    {
        ...
        switch ($columnId) {
            case 'szy_created_at':
                ...
                $customFormatComment = 'd - days(d or dd)<br />';
                $customFormatComment .= 'M - month(M or MM)<br />';
                $customFormatComment .= 'yy - years(yy or yyyy)<br />';
                $customFormatComment .= 'H - hours(H or HH)<br />';
                $customFormatComment .= 'm - minutes(m or mm)<br />';
                $customFormatComment .= 'a - am or pm<br />';
                $customFormatComment .= '"Custom Date Format" default dd MM yyyy <br />';
