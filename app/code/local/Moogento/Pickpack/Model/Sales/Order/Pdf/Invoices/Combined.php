...
class Moogento_Pickpack_Model_Sales_Order_Pdf_Invoices_Combined extends Moogento_Pickpack_Model_Sales_Order_Pdf_Invoices
{
    ...
    public function getPickCombined($orders = array(), $output = 'order_combined') //$shipments = array(), $from_shipment = 'order')
    {
            ...
            foreach ($itemsCollection as $item) {
                ...
                */
                ...
                if ($shelving_yn == 1) {
                    ...
                    }else $shelving =  $this->getProductAttributeValue($product,$shelving_attribute);
                ...
                if ($extra_yn == 1) {
                    //option 1
//                  $extra_var = $this->getProductAttributeValue2($product,$extra_attribute,$store_id,$product_id);
                    //option 2
                    if ($non_standard_characters!=0){
                        $extra_var =  $this->getProductAttributeValue($product,$extra_attribute,false);
                    }else $extra_var =  $this->getProductAttributeValue($product,$extra_attribute);
                ...
                if ($extra3_yn == 1) {
                    if ($non_standard_characters!=0){
                        $extra3_var =  $this->getProductAttributeValue($product,$extra3_attribute,false);
                    }else $extra3_var =  $this->getProductAttributeValue($product,$extra3_attribute);
                ...
                if ($extra4_yn == 1) {
                    if ($non_standard_characters!=0){
                        $extra4_var =  $this->getProductAttributeValue($product,$extra4_attribute,false);
                    }else $extra4_var =  $this->getProductAttributeValue($product,$extra4_attribute);
        ...
        if ($split_supplier_yn != 'no') {
            ...
            foreach ($supplier_master as $key => $supplier) {
                if ((isset($supplier_login) && ($supplier_login != '') && (strtoupper($supplier) == strtoupper($supplier_login))) || !isset($supplier_login) || $supplier_login == '') {
                    ...
                    if ($picklogo == 1) {
                        ...
                        $page->drawText($picklist_title, 325, 810, 'UTF-8');
                    ...
                    if ($col_title_position_attr2[1] < ($xX + (2 * $font_size_body) + 5))
                        $col_title_position_attr2[1] = ($xX + (2 * $font_size_body) + 5);
                    if ($col_title_position_name[1] < ($xX + (2 * $font_size_body) + 5))
                        $col_title_position_name[1] = ($xX + (2 * $font_size_body) + 5);
                    ...
                    array_multisort($sortArray[$orderby],SORT_ASC,$sku_master);                     
                        ...
                        if( $sort_packing_order ) {
                           ...
                           $orderby_Secondry = $this->_getConfig('sort_packing_secondary',1, false, $config_group); //change this to whatever key you want from the array                                           
                            $position = $this->_getConfig('sort_packing_order',1, false, $config_group);
                            $position_secondry = $this->_getConfig('sort_packing_secondary_order',1, false, $config_group);

                            if( $position == 'descending' && $position_secondry == 'descending' ){                    
                               array_multisort($sort_array2[$orderby],SORT_DESC,$sort_array2[$orderby_Secondry],SORT_DESC,$array_bundle);
                            }else{                     
                               array_multisort($sort_array2[$orderby],SORT_ASC,$sort_array2[$orderby_Secondry],SORT_ASC,$array_bundle);
                            }                               
                        }                                           
                            ...
                            if ($supplier_item_action != 'hide' && $supplier_item_action != '') {
                                ...
                                if ((($product_sku_barcode_yn == 1) || ($product_sku_barcode_yn == 2))) {
                                    ...
                                    if ($barcodeWidth < ($padded_right / 2)){
                                        ...
                                        $this->_setFont($page, $font_style_body, $font_size_body, $font_family_body, $non_standard_characters, '#FF3333');
                    ...
                    if ($showcount_yn == 1) {
                        ...
                        if ($from_shipment == 'shipment') {
                            ...
                            $this->_setFont($page, 'bold', $font_size_body, $font_family_body, $non_standard_characters, $font_color_body);
                            $page->drawText($helper->__('Items') . $text_addon_totalqty . ' : ' . $total_quantity, 370, $this->y, 'UTF-8');
                        }
                    }
                    if ($sheet_has_bundles === true) {
                        ...
                        $this->_setFont($page, 'bold', $font_size_body, $font_family_body, $non_standard_characters, $font_color_body);
                        $page->drawText(($helper->__('Bundle') . ' : ' . $total_bundle_quantity), 370, $this->y, 'UTF-8');
                    }
                    if ($order_count_yn == 1) {
                        $this->y -= $font_size_body * 1.4;
                        $this->_setFont($page, 'bold', $font_size_body, $font_family_body, $non_standard_characters, $font_color_body);
                    ...
                    if (($showcost_yn == 1) && ($total_cost > 0)) {
                        $this->y -= $font_size_body * 1.4;
                        if ($from_shipment == 'shipment')
                            $page->drawText($helper->__('Total cost these shipments') . ' : ' . $currency_symbol . "  " . $total_cost, 375, $this->y, 'UTF-8');
                        else
            ...
            if ($picklogo == 1) {
                ...
                if ($output == 'trolleybox') {
                    ...
                    if ($from_shipment == 'shipment') {
                        $page->drawText($helper->__('Shipment-combined Pick List'), 325, ($page_top - 10), 'UTF-8');
                    } else {
                        $page->drawText($helper->__('Order-combined Pick List'), 325, ($page_top - 10), 'UTF-8');
                    }
                }
                $page->setFillColor($font_color_header_zend);
                $page->setLineColor($font_color_header_zend);
                $page->setLineWidth(0.5);
                $page->drawRectangle(304, $y1, 316, ($page_top + 5));
                $page->drawRectangle(27, $this->y, $padded_right, ($this->y - 1));
                $this->y -= 20;
            } else {
                $this->_setFont($page, $font_style_header, ($font_size_header + 2), $font_family_header, $non_standard_characters, $font_color_header);
            ...
            $skuXreal = $col_title_position_sku[1] ;//+ $max_qty_length_display);
            // if ($skuXreal < ($xX + (2 * $font_size_body) + 5)) {
//                 $skuXreal                  = ($xX + (2 * $font_size_body) + 5);
//                 $col_title_position_sku[1] = $skuXreal;
//             }
            if ($col_title_position_attr2[1] < ($xX + (2 * $font_size_body) + 5))
                $col_title_position_attr2[1] = ($xX + (2 * $font_size_body) + 5);
            if ($col_title_position_name[1] < ($xX + (2 * $font_size_body) + 5))
                ...
                if ((!in_array($sku, $processed_skus) || ($trolleybox_yn == 1)) && $sku != '') {
                    ...
                    if ($grey_next_line == 1) {
                        ...
                        if($combine_attribute_yn == 1){
                            ...
                            if($grey_box_y1 > $this->y - $font_size_body/5 - ($count_attribute)*($font_size_body + 2))
                                $grey_box_y1 = $this->y - $font_size_body/5 - ($count_attribute)*($font_size_body + 2);
                        }
                    ...
                    */
                                ...
                                if($trim_product_name_yn == 1)
                                    ...
                                    if ($token != false) {
                                        ...
                                        if ($grey_next_line == 0 && count($multiline_name_array) > 1 && !isset($sku_image_paths[$sku]['path'][0])) {
                                            $page->setFillColor($grey_bkg_color);
                                            $page->setLineColor($grey_bkg_color);
                                            $page->drawRectangle(25, ($this->y - ($font_size_body*(count($multiline_name_array)))), $padded_right, $this->y);
                                            $page->setFillColor($black_color);
                                            $this->_setFont($page, $font_style_body, $font_size_body, $font_family_body, $non_standard_characters, $font_color_body);
                    ...
                    if ($product_qty_upsize_yn == '1' || $product_qty_upsize_yn == '2') {
                    ...
                    if($combine_attribute_yn == 1 && $combine_attribute_array != ''){
                        foreach ($combine_attribute_array as $key => $value_attribute) {
                            ...
                            $yTempPosCombine -= ($font_size_body + 2);
                        }
                        $yTempPosCombine += ($font_size_body + 2);
                    ...
                    if ((($product_sku_barcode_yn == 1) || ($product_sku_barcode_yn == 2))) {
                        ...
                        $barcode_Y = $this->y - 2;
                        $barcodeString = $this->convertToBarcodeString($barcode, $barcode_type);
                        $barcodeWidth = 1.25 * $this->parseString($barcode, Zend_Pdf_Font::fontWithPath($this->action_path . $font_family_barcode), $barcode_font_size);
                        $page->setFillColor($white_color);
                        $page->setLineColor($white_color);
                    ...
                    if (isset($sku_order_id_options[$sku]) && $sku_order_id_options[$sku] != '' && $options_yn == 'newline') {
                        ...
                        $this->y -= $lines_of_name*$font_size_body;
                    ...
                    if ($stockcheck_yn == 1) {
                        if ($sku_stock[$sku] < $stockcheck) {
                            ...
                            if ($col_title_position_stock[1] > 1) {
                                ...
                                $page->drawRectangle($col_title_position_stock[1] - 2 + 7, ($this->y - 1.5), ($col_title_position_stock[1] + ($font_size_body * (1.5 + (0.5 * strlen($sku_stock[$sku])))) + 2 + 7), ($this->y + ($font_size_body - 1.5)));
                                $page->setFillColor(new Zend_Pdf_Color_GrayScale(0));
            ...
            if ($showcount_yn == 1) {
                ...
                if ($from_shipment == 'shipment') {
                    ...
                    $page->setLineWidth(1);
                    $this->_setFont($page, 'bold', $font_size_body, $font_family_body, $non_standard_characters, $font_color_body);
                    $page->drawText($helper->__('Items') . $text_addon_totalqty . ' : ' . $total_quantity_ordered, 370, $this->y, 'UTF-8');
                }
            }
            ...
            if ($showcount_shipped_yn == 1 && $from_shipment != 'shipment')
            {
				...
				$page->setLineWidth(1);
				$this->_setFont($page, 'bold', $font_size_body, $font_family_body, $non_standard_characters, $font_color_body);
				$page->drawText($helper->__('Shipped items').' : ' . $total_quantity_shipped, 370, $this->y, 'UTF-8');
                }
            ...
            if ($showcount_invoiced_yn == 1 && $from_shipment != 'shipment')
            {
				...
				$page->setLineWidth(1);
				$this->_setFont($page, 'bold', $font_size_body, $font_family_body, $non_standard_characters, $font_color_body);
				$page->drawText($helper->__('Invoiced items').' : ' . $total_quantity_invoiced, 370, $this->y, 'UTF-8');
            }
