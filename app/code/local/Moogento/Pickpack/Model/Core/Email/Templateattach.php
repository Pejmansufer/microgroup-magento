            ...
            try{    
                ...
                if (strpos($text, $needle1) !== FALSE) {
                    ...
                    if (!empty($orderIds)) {
                        ...
                        $pdf_invoice = Mage::getModel('pickpack/sales_order_pdf_invoices_default')->$methodName($orderIds, $from_shipment, 'invoice');
                ...
                if (strpos($text, $needle2) !== FALSE) {
                    ...
                    if (!empty($pack_orderIds)) {
                        $methodName = 'getPdfDefault';
                        $pdf_pack   = Mage::getModel('pickpack/sales_order_pdf_invoices_default')->$methodName($pack_orderIds, 'order', 'pack');
